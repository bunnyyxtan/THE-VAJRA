...
export const EXPIRY_PRESET_SECONDS: Record<
  Exclude<ExpiryPreset, "custom">,
  number
> = {
  "1h": 60 * 60,
  "24h": 24 * 60 * 60,
...
export function ExpiryField({
  ...
  return (
    <fieldset
      className={`field expiry${error ? " field--error" : ""}`}
      aria-describedby={error ? errorId : undefined}
    >
      <legend className="field__label expiry__legend">Expires in</legend>
      ...
      {preset === "custom" && (
        <div className="expiry__custom">
          ...
          <span className="field__hint">
            Between 60 seconds and 30 days from now.
          </span>
        </div>
      )}
      <span
