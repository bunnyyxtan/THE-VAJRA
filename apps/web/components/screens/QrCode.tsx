...
/**
 * QrCode — renders a payment link as a static SVG QR code.
 *
...
export function QrCode({ value, label }: { value: string; label: string }) {
  ...
  if (!svg) {
    return (
      <div className="qr__frame qr__frame--pending" role="status" aria-label="Generating QR code">
        <span className="qr__skeleton" aria-hidden="true" />
      </div>
    );
  }
